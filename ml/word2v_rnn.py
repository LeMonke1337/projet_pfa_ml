...
with open("accuracy/accuracy_report_lstm.txt", "w") as f:
...
def predict_category_lstm(custom_profile, tokenizer, model, label_encoder, max_length):
    custom_text = (
...
for i, profile in enumerate(test_profiles):
    predicted_category = predict_category_lstm(
