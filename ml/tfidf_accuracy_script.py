...
for index, row in df.iterrows():
    ...
    recommended_category, _ = recommend_category(custom_profile, df)
...
with open("accuracy/accuracy_tfidf.txt", "w") as f:
...
for i, profile in enumerate(test_profiles):
    recommended_category, similarity_score = recommend_category(profile, df)
    print(
