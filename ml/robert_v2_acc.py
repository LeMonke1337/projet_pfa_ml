...
model = TFRobertaForSequenceClassification.from_pretrained(
    "./model_roberta_v1", num_labels=num_labels
)
...
def predict_category_roberta(custom_profile, tokenizer, model, label_encoder):
    custom_text = (
...
for i, profile in enumerate(test_profiles):
    predicted_category = predict_category_roberta(
